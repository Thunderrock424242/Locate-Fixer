...
public final class WorldLocatorIndex extends SavedData {
    ...
    private static final Factory<WorldLocatorIndex> FACTORY =
            new Factory<>(WorldLocatorIndex::new, WorldLocatorIndex::load, DataFixTypes.LEVEL);
    ...
    private static WorldLocatorIndex load(CompoundTag tag, HolderLookup.Provider registries) {
